## Workflow to resolve strains from long-read assemblies using Floria.
### Usage

```

=================================================================================
 STRAIN RESOLUTION OF ASSEMBLIES USING FLORIA: TAPIR Pipeline version 1.0dev
=================================================================================
...
## Introduction
This pipeline attempts to resolve strains from long-read assemblies. This Nextflow pipeline was adapted from the original author's [Github page](https://github.com/bluenote-1577/floria).  
